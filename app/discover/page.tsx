    ...
    <section className="px-5 py-24 lg:px-8">
      ...
      <div className="mx-auto mt-14 max-w-5xl texture-card rounded-[2rem] p-8 md:p-12">
        <div className="grid gap-10 md:grid-cols-[1.2fr_.8fr] md:items-center">
          <div>
            <h2 className="text-4xl font-black tracking-[-.035em] text-ink md:text-5xl">Start with clarity.</h2>
          ...
          <div className="rounded-3xl border border-slate/15 bg-slate p-7">
            <p className="text-sm font-extrabold uppercase tracking-[0.32em] text-ember">Next step</p>
            <p className="mt-4 text-sm leading-7 text-slate">
              Replace this button with the real Pathwright link when the track is ready.
            </p>
            <Link href="/contact" className="button-primary mt-7 inline-flex w-full items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-bold transition">
